jQuery(document).ready(function($) {
    $('.mash-menu').mashableMenu({
        ...
        vertical_tabs_effect_speed: 300, // Value in milliseconds. This option is used to change the vertical tabs showing or hiding speed
        /* RESPONSIVE TABS */
    ...
    $('#search').focusin(function(e) {
        ...
        e.preventDefault();
        $('i.fa-search').toggleClass('fa-ban');
    ...
    $("i.fa").click(function() {
        $("#search").val('');
        $('i.fa-search').removeClass('fa-ban');
    });
